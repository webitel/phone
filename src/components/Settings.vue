...
<script>
    ...
    export default {
      ...
      data () {
        return {
          useWebPhone: settings.get("useWebPhone") === "true",
          sipAutoAnswer: settings.get("sipAutoAnswer") === "true",
          autoLoginCallCenter: settings.get("autoLoginCallCenter") === "true",
          agentOnDemand: settings.get("agentOnDemand") === "true",
          usePostProcess: settings.get("usePostProcess") === "true",
          notifyNewCall: settings.get("notifyNewCall") === "true",
          notifyMissedCall: settings.get("notifyMissedCall") === "true",
          ...
          ringInboundCall: settings.get("ringInboundCall") === "true",
